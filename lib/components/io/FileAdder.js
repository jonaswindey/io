...
import {Well, Button, Row, Col, Tabs, Tab, FormGroup, FormControl} from 'react-bootstrap'
...
class FileAdder extends Component {
  ...
  onUpload() {
    ...
    this.props.dispatch(fileActions.upload(DEFAULT_PROJECT, blob, this.state.fileName, this.state.fileId))
