...
import {Col, Form, FormGroup, FormControl, ControlLabel, Row, Alert} from 'react-bootstrap'
...
export default class Login extends React.Component {
  ...
  register(e) {
    ...
    if (firstName.length > 0 && lastName.length > 0
      ...
      store.dispatch(actions.register({firstName, lastName, email, password, history}))
  }
      ...
      <div className="wrap">
        <div className="container">
          <div className="paper paper-curve-horiz request">
            <Row>
              <Col lgOffset={2} lg={8} mdOffset={1} md={10}>
                <Alert>
                  <span style={{
                    whiteSpace: 'pre'
                  }}>
            ...
            <Row>
              <Col lg={4} lgOffset={2} md={5} mdOffset={1}>
                <form onSubmit={(e) => this.handleSubmit(e)}>
                  ...
                  <h3><FormattedMessage id='shared.signIn'/></h3>


                  <FormGroup>
                    <ControlLabel><FormattedMessage id = 'signin.email' /></ControlLabel>
                    <FormControl type="email" onChange={::this.emailChange} value={this.state.email} />
                  </FormGroup>
              ...
              <Col lg={4} lgOffSet={2} md={5}>
                <Form onSubmit={(e) => this.register(e)}>
                  ...
                  <h3><FormattedMessage id='signin.register'/></h3>
                  <FormGroup>
