  ...
  return (
    <ReduxRouter>
      <Route component={Application}>
        <Redirect from="/admin/reporting" to="/admin/reporting/2016/turnover" />
        <Route
          path="/" component={Home}
          />
        <Route
        ...
        <Route name="admin" path="/admin" >
            <Route name="admin/products" path="/admin/products" component={AdminProducts}>
              <Route name="admin/product" path="/admin/product/:id" component={AdminProduct} />
            </Route>
            <Route name="admin/users" path="/admin/users" component={Users}>
                <Route name="admin/user" path="/admin/user/:id" component={User} />
            </Route>
            <Route name="admin/reporting" path="/admin/reporting">
                <Route name="admin/user" path="/admin/reporting/:year/:report" component={Reporting} />
            </Route>
        </Route>
        <Route
          name='profile'
